...
import os
import math
rootdir=os.path.join('/Users/tfh/deep learning/acfr-fruit-dataset/almonds/annotations')
...
for name in files:
    if name[-3:] == 'csv':
        ...
        xmlname = name[:-3] + 'xml'
        xmlroot = '/Users/tfh/pytorch-faster-rcnn/data/VOCdevkit2007/VOC2007/Annotations'
